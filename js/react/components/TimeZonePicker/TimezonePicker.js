...
import { Button, Input, Label,InputGroupText ,InputGroupAddon, InputGroup} from 'reactstrap'
...
class TimezonePicker extends React.Component {
  ...
  handleKeyPress(e) {
    const { focused, timezones,value } = this.state;
        ...
        <div className="timezone-picker-textfield">
          <div className="input-wrap">
            <Input
              ...
              {...rest}
            />
            <span className="caretTimeZone"><img src={VectorIcon} alt='vector' /></span>
          </div>
          {isOpen && (
