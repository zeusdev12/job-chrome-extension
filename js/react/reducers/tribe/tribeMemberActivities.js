...
const tribeMemberActivities = (state = initialState, action) => {

    switch (action.type) {

        case ActionTypes.FETCH_TRIBE_MEMBER_ACTIVITY:
        ...
        case ActionTypes.FETCH_TRIBE_MEMBER_ACTIVITY_SUCCESS:
        ...
        case ActionTypes.FETCH_TRIBE_MEMBER_ACTIVITY_FAILURE:
            return initialState

        case ActionTypes.CLEAR_STATE_ACTIVITY:
           return{...state,
            totalDataLeft : 0,
            activityList : [],
            currentPageNo:1
...
export default tribeMemberActivities;